...
$idmovi= $_GET['id']; // aqui se revibe el parametro que se pasa por utl para realizar la consulta

$sqlE="select m.*,s.*
from tbsalida s
join tbmovimiento m on m.idmovimiento=s.idmovimiento
where m.idmovimiento=".$idmovi;// <-- en esa variable se almacena el valor y con eso traemos todo los datos del movimietno
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="solicitante" name="solicitante" class="form-control" type="text" value="<?php echo $rowE[8]; ?>" required/> 
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="maquina" class="form-control">
                                            <option value="0">Seleccione</option>
                                            <option value="2" <?php if($rowE[12]==2){ echo "selected"; } ?>>pr-pre-01</option>
                                            <option value="3" <?php if($rowE[12]==3){ echo "selected"; } ?>>pr-mau-02</option>
                                            <option value="4" <?php if($rowE[12]==4){ echo "selected"; } ?>>pr-per-04</option>
                                            <option value="5" <?php if($rowE[12]==5){ echo "selected"; } ?>>ta-tor-02</option>
                                            <option value="6" <?php if($rowE[12]==6){ echo "selected"; } ?>>pr-mol-02</option>
                                        </select>   
                                    </div>
                                </div>
                            </div>
...
if ($_POST['Guardar']) {
    ...
    $sql = " update `tbmovimiento` SET fecha='" . $fecha . "',hora='" . $hora . "',cantidad='" . $cantidad . "',tipomovimiento='" . $tipomov . "',idalmacen='"
            . $almacen . "',idproducto='" . $producto . "',idencargado='" . $encargado . "' WHERE idmovimiento=".$idmovi;
    ...
    $sql2 = " update `tbsalida` SET solicitante='" . $solicitante . "',idmaquina='" . $maquina . "' WHERE idmovimiento=" . $idmovi ;
    echo $sql2;
