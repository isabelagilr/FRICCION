...
$sqlEl = "Delete from tbpersona where idpersona=".$idmov;
...
<html lang="en">
    <head>
        ...
        <META HTTP-EQUIV='Refresh' CONTENT="2; URL=personas.php">
    ...
    <body>
        ...
        <div id="wrapper">
            <div class="container">
                ...
                <h3 class="alert alert-info">Usuario eliminado correctamente</h3>
            </div>
        </div>
