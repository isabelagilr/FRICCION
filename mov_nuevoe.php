        ...
        <div id="wrapper">
                                ...
                                <div class="col-lg-6"> 
                                 ...
                                 <div class="col-lg-6"> 
                                    <div class="form-group">
                                        ...
                                        <input id="ubiacion" name="ubicacion" class="form-control" type="text" value="" required /> 
                                    </div>
                                </div>
            ...
            if($_POST['Guardar'])
          {
                ...
                $sql=" INSERT INTO `tbmovimiento` VALUES ("."null,'".$fecha."','".$fecha."''".$hora."','".$cantidad."','".$tipomov."','"
                        .$almacen."','".$producto."',(select idpersona from tbpersona where usuario='".$encargado."'))";
                ...
                $sql2=" INSERT INTO `tbentrada` VALUES ("
                        ."'".$costo."','".$nombreprov."','".$ubicacion."',"
                         ."(select max(idmovimiento) from tbmovimiento),'".$estado."')";
                echo $sql2;
