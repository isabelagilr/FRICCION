                    ...
                    <table class="table table-responsive table-striped">
                     ...
                     while($row = mysqli_fetch_row($result)){
                        ...
                        <tr>
                           ...
                           <td>
                               <a href="editar_persona.php?id=<?php echo $row[0]; ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Editar</a>
                               <a href="eliminar_persona.php?id=<?php echo $row[0]; ?>" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> Eliminar</a>
                           </td>
                        </tr>
                        <?php
                      }
