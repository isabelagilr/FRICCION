            ...
            <div class="container">
                <div class="row" id="listaPersonas">
                    ...
                    <table class="table table-responsive table-striped">
                        ...
                        <?php
                        $sql = "SELECT `idmovimiento`, `fecha`, `hora`, `cantidad`, `tipomovimiento`, `idalmacen`, `idproducto`, `idencargado` FROM `tbmovimiento` WHERE tipomovimiento like 'Salida' ";
                        ...
                        while ($row = mysqli_fetch_row($result)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="editar_salida.php?id=<?php echo $row[0]; ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Editar</a>
                                    <a href="eliminar_salida.php?id=<?php echo $row[0]; ?>" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> Eliminar</a>
                                </td>
                            </tr>
                            <?php
                        }
                        ...
                        <a href="mov_nuevos.php" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> Nuevo Resgistro</a> 
