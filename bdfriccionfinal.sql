...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-01-2019 a las 22:41:37
...
(9, '0000-00-00', '00:00:00.000000', 0, '', 1, 3, 0);
...
(4, 'guido', 'andrade', 'gamarra', 'jefe contabilidad', '75035265', 'gandrade@friccion-bo.com', 'gandrade', 'a01d9fc480ea028f5fc8be891160354871697097'),
...
(9, 'isabela', 'gil', 'rodrigues', 'externo', '70877577', 'isabelagilr@hotmail.com', 'igil', '59dc310530b44e8dd1231682b4cc5f2458af1c60'),
(10, 'blanca', 'villafuerte', 'cuadros', 'externo', '75025485', 'bvillafuerte@hotmail.com', 'bvillafuerte', '801e500042dcf4b01512c510b1d8e776c79eb84f');
...
--
ALTER TABLE `tbmovimiento`
  MODIFY `idmovimiento` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `tbpersona`
--
ALTER TABLE `tbpersona`
  MODIFY `idpersona` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
